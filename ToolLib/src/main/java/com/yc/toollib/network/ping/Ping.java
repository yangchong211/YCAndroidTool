...
public class Ping {
    ...
    public static void ping1(Context context , String url) throws Exception {
        ...
        if (!commonFilePath.exists()) {
            ...
            ToolLogUtils.w(TAG, "create path: " + commonFilePath);
        }
        ...
        try {
            ...
            ToolLogUtils.e(TAG, "hostName: " + hostName);
    ...
    public static void killPing() {
        if (process != null) {
            process.destroy();
            ToolLogUtils.e(TAG, "process: " + process);
        }
    }
