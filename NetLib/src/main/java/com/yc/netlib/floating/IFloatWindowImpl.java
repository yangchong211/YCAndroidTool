...
public class IFloatWindowImpl extends IFloatWindow {
    ...
    public void updateX(int screenType, float ratio) {
        ...
        mB.xOffset = (int) ((screenType == Screen.width ?
                FloatUtils.getScreenWidth(mB.mApplicationContext) :
                FloatUtils.getScreenHeight(mB.mApplicationContext)) * ratio);
                            ...
                            case MotionEvent.ACTION_UP:
                                ...
                                switch (mB.mMoveType) {
                                    case MoveType.slide:
                                        ...
                                        int endX = (startX * 2 + v.getWidth() > FloatUtils.getScreenWidth(mB.mApplicationContext)) ?
                                                FloatUtils.getScreenWidth(mB.mApplicationContext) - v.getWidth() - mB.mSlideRightMargin :
                                                mB.mSlideLeftMargin;
